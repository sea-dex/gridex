forge script --chain base-sepolia script/GridExTestnet.s.sol:GridExScript --rpc-url $BASE_TESTNET_RPC --broadcast
...
forge create --chain-id 84532 --private-key $PRIVATE_KEY --rpc-url $BASE_TESTNET_RPC --verify -e $ETHERSCAN_API_KEY src/Router.sol:Router --constructor-args 0x2181c894e4c04d1eb0579570ea6e9030446ab086
