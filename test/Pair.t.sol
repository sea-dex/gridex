...
/*
    ...
    function test_PlaceGridOrder() public {
        ...
        uint256 askPrice0 = (50 * PRICE_MULTIPLIER) / 10 / (10 ** 12);
        uint256 bidPrice0 = (49 * PRICE_MULTIPLIER) / 10 / (10 ** 12);
    ...
    function test_FillAskGridOrder_01() public {
        ...
        uint256 perBaseAmt = 100 * 10 ** 18;
        uint256 askPrice0 = (50 * PRICE_MULTIPLIER) / 10 / (10 ** 12);
        uint256 usdcAmt = (10 * uint256(asks) * perBaseAmt * askPrice0) /
            PRICE_MULTIPLIER;
        ...
        {
            uint256 filledVol = (perBaseAmt * (askPrice0)) / PRICE_MULTIPLIER;
            uint256 fee = (filledVol * 500) / 1000000;
            uint256 quota = (perBaseAmt * (askPrice0 - gap)) /
                PRICE_MULTIPLIER;
    ...
    function test_FillBidGridOrder_01() public {
        ...
        uint256 perBaseAmt = 100 * 10 ** 18;
        uint256 bidPrice0 = (50 * PRICE_MULTIPLIER) / 10 / (10 ** 12);
        uint256 usdcAmt = (uint256(bids) * perBaseAmt * bidPrice0) /
            PRICE_MULTIPLIER;
        ...
        {
            uint256 filledVol = (perBaseAmt * (bidPrice0)) / PRICE_MULTIPLIER;
